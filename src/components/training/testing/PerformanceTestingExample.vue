<template>
  <div class="space-y-6">
    <div class="p-4 bg-blue-50 rounded-lg">
      <h3 class="text-lg font-semibold text-blue-900 mb-2">性能测试与优化演示</h3>
      <p class="text-sm text-blue-800">渲染压力测试与简单优化对比</p>
    </div>

    <div class="bg-white border rounded-lg p-6 space-y-4">
      <div class="grid md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">渲染条目数</label>
      ...
      <div class="flex flex-wrap gap-3">
        <button @click="run" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">开始渲染</button>
        <button @click="clear" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">清除列表</button>
      </div>

      <div class="text-sm text-gray-700">渲染耗时：<span class="font-semibold">{{ duration }}ms</span></div>
    </div>

    <div class="bg-white border rounded-lg p-6">
      <h4 class="text-lg font-medium text-gray-900 mb-3">列表</h4>
      <div class="grid md:grid-cols-2 gap-6">
        <div>
          <h5 class="font-medium text-gray-900 mb-2">当前渲染</h5>
        ...
        <div>
          <h5 class="font-medium text-gray-900 mb-2">优化结果快照</h5>
          <div class="max-h-64 overflow-auto border rounded">
            <ul>
